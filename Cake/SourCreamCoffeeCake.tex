...
\hint{Since most sour cream containers are \C{2}, you can just use the whole container.}
\hint{The band in the middle may be faint, so can double the amount of topping if desired.}
\end{recipe}
