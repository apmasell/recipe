...
{\noindent\textit{Ingredients:}\begin{itemize*}\setlength{\itemsep}{-1pt}\setlength{\itemindent}{-1.2pc}\renewcommand{\labelitemi}{$\cdot$}}{\end{itemize*}}
...
\newcommand{\seerecipe}[1]{~(See page~\pageref{rcp:##1})\ }
