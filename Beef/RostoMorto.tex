...
\begin{ingredients}
\item olive oil
\item \kgr{1\half} \theme{beef} top-side cap
...
\hint{The Italian name for this cut of beef is ``piccione'', meaning pigeon.}
\hint{Other cuts of beef for pot roast will work fine.}
\hint{Pan contents can also be puréed at end, if desired.}
\end{recipe}
