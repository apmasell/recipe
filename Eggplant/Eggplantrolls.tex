\begin{recipe}{Eggplant Rolls}{Nonna}{}

\begin{ingredients}
\item 3~medium \theme{eggplant}
\item plain tomato sauce\seerecipe{PastaSauce:PlainTomatoSauce} diluted with water
\item 3~eggs
\item all-purpose flour
\item vegetable oil
\item prosciutto cotto cut in \inch{2} strips
...
\item Fry slowly in \inch{1} vegetable oil until golden. Turn once.
