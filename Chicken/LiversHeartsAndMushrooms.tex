...
\begin{ingredients}
\item 10 to 15~\theme{chicken} livers
\item 10 to 15~chicken hearts
\item 1~clove of garlic, minced
\item \half{}~small onion, minced
\item \threequarter{} to \lbs{1} \theme{mushroom}s, sliced
\item \tp{\half} paprika
\item wine
\item salt
\item pepper
...
\item Sauté onions and garlic in olive oil until golden.
