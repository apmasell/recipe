\begin{recipe}{Chocolate-Sheathed Almond Biscotti}{}{about 4\half\ dozen}
...
\item \C{\threequarter} plus \Tp{2} sugar
\item \tp{1} baking soda
\item \tp{\half} salt
\item \tp{2} ground cinnamon
\item \C{\threequarter} toasted raw \theme{almonds} chopped into halves or thirds
\end{ingredients}
...
\item One at a time, place the 2~dough portions on the prepared baking sheet and form each into a log about \inch{\half} high, \inch{1 \half} wide, and \inch{14} long.
...
\begin{ingredients}
\item \oz{6} bittersweet chocolate
