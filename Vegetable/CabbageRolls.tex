...
\hint{It is also possible to use pickled cabbage leaves. Two \L{1\half} jars have enoug leaves for this recipe. Do not steam the leaves. Soak them in water to remove salt before using anddo not salt the layers.}
\end{recipe}
