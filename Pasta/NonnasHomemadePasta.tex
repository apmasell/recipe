...
\item Divide into slices and press in \inch{4} discs, about \inch{\threequarter} thick.
...
\hint{Instead of running through the pasta machine, the dough can be rolled into ropes and cut into ``pillows''. With finger tips or a dull knife, the pillows can be smeared along a wooden surface so they curl on themselves to become ruccoli.}
\end{recipe}
