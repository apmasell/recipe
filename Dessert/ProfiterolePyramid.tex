\begin{recipe}{Profiterole Pyramid}{}{18-20}
...
\item Reduce heat to \tF{350} and continue baking until puffs are well risen and dry, about 10 to 15~minutes.
\item Let cool.
\item Slit puffs.
...
\subrecipe{French Vanilla Cream\FIXME}
\begin{ingredients}
\item \C{\twothird} sugar
\item \C{\half} all-purpose flour
\item \tp{\half} salt
\item \C{3} scalded milk
