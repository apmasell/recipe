...
\hint{The ``exact'' amount is \Tp{1\half} each sugar and oil per egg, but using kitchen table-spoons, not calibrated ones.}
\hint{Substitute \Tp{3} cocoa for flour to make chocolate pizzelle.}
\end{recipe}
