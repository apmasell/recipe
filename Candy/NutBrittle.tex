...
\item Cook until mixture begins to turn golden brown. (Approx \tF{300}.)
...
\hint{ Leaving out the nuts entirely is possible and results in a vanilla
Werther's-like candy. }
\end{recipe}
