...
\hint{The protein content of the flour must be adjusted if it is lower than 15\%. 5~Roses \emph{Never Bleached} is 13\%, so \gr{6} 75\% gluten flour must be substituted.}
\end{recipe}
