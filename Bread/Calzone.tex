...
\item 1~batch of \theme{Swiss chard} with \seerecipe{Vegetable:SwissChardWithPepparule}
\item olive oil
\end{ingredients}
...
\hint{The sausage meat can be prepared directly from \seerecipe{Pork:Sausage}.}
